...
@section('content')
    ...
    <div class="flex-center position-ref p-t-60 p-b-60">
        <div class="container">
            ...
            {{-- <vue-coupon v-model="coupon"></vue-coupon> --}}
            {{-- My Experement --}}
            <vue-coupon></vue-coupon>
            <hr>
            <hr>
            {{-- here it's not working because it's inside #app id --}}
